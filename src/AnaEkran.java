...
public class AnaEkran{
    ...
    public void AnaEkran(){ //Sisteme giriş ekranıdır. Kullanıcıya üyelik ve giriş ekranı sunar.
        ...
        while (true){
            ...
            giris.GirisVeKayit();
            String yetki = giris.getYetki();
            int secim = giris.getSecim();
            if (secim == 3){
                break;
            }else {
                if (yetki != null) {
        ...
        while (true){
            ...
            switch (secim){
                ...
                case 4:
                    ...
                    break;
                case 5:
                    TomrukIslem.Istifleme istifleme = new TomrukIslem.Istifleme();
                    System.out.println("Görmek istediğiniz türü seçiniz: \n 1:Çam 2:Meşe 3:Kayin 4:Ladin");
                    int tur = scanner.nextInt();
                    if (tur == 1){istifleme.okumaTomruk("cam.csv");}
                    else if (tur == 2){istifleme.okumaTomruk("mese.csv");}
                    else if (tur == 3){istifleme.okumaTomruk("kayin.csv");}
                    else if (tur == 4){istifleme.okumaTomruk("ladin.csv");}
                    else {
